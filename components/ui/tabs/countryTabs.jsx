      ...
      <div className="w-full flex flex-wrap  items-center p-3 px-6 cursor-pointer">
        <ul className="w-full flex  items-center justify-between  flex-wrap">
          <li
            ...
            className={`duration-100 text-[12px] ${
              tabStatus === "home" ? "text-blue-400" : "text-gray-500 "
            } `}
          >
            {trans("Home")}
          </li>
          <li
            onClick={() => setTabStatus("travelers")}
            className={`duration-100 text-[12px] ${
              tabStatus === "travelers" ? "text-blue-400" : "text-gray-500 "
            } `}
          >
            {trans("Travelers")}
          </li>
          <li
            onClick={() => setTabStatus("events")}
            className={`duration-100 text-[12px] ${
              tabStatus === "events" ? "text-blue-400" : "text-gray-500 "
            } `}
          >
            {trans("Events")}
          </li>
          <li
            onClick={() => setTabStatus("travel-guide")}
            className={`duration-100 text-[12px] ${
              tabStatus === "travel-guide" ? "text-blue-400" : "text-gray-500 "
            } `}
          >
            {trans("Travel Guide")}
          </li>
