    ...
    return (
        <section className="w-full overflow-x-hidden flex page-up-animation pb-24 bg-white flex-wrap">
            <figure className="flex flex-wrap relative w-full md:w-[375.81px] h-fit">
                <Image src={UserProfileImage} className="object-cover w-full" alt={"UserProfileImage"} width={375} height={375}/>
                <div className='absolute flex items-center justify-between px-5 top-5 w-full'>
                    <CloseButtonComponent/>
                    <div className="items-center flex gap-2">
                        <div
                            className="bg-gradient-to-l px-2.5 h-8 rounded-lg flex items-center gap-2 to-[#FFD644] p-1 from-[#FF68C7]">
                ...
                <div className="w-full rounded-t-3xl bg-white -translate-y-3  p-2 relative bottom-0">
                    <div
                        className="w-full flex flex-wrap absolute content-center transform -translate-y-14 justify-center text-white">
                        ...
                        <figure className="w-full flex gap-2 flex-wrap items-center justify-center">
                            ...
                            <span className="text-[12px] tracking-[4px]">
                                    Italy
                                </span>
                        </figure>
                    </div>
            ...
            <section className="w-full justify-between  items-center flex flex-wrap ">
                <div className="w-full flex px-4 pb-5 items-center justify-between ">
                    <Link href={`/${params.locale}/message`} passHref prefetch={true}
                          className="flex items-center justify-center border rounded-xl w-[156px] h-[48px] gap-2">
                        <Image src={MessageIcon} alt={"MessageIcon"} width={18} height={18}/>
                        <span className="text-gray-700 text-sm">{trans("message")}</span>
                    </Link>
                    <Link href={"/message"} passHref prefetch={true}
                          className="flex items-center justify-center border rounded-xl w-[156px] h-[48px] gap-2">
                        <Image src={AddFriendIcon} alt={"AddFriendIcon"} width={18} height={18}/>
                ...
                <div className='w-full flex flex-wrap px-4 py-2'>
                    <h4 className='w-full font-bold py-2'>
                        {trans("Interests")}
                    </h4>
                ...
                <div className='w-full flex flex-wrap px-4 py-2'>
                    ...
                    <div className='w-full flex flex-wrap gap-2'>
                        <div className="flex items-center justify-center border rounded-xl max-w-fit p-2 py-3 gap-2">
                            <span className="text-gray-700 text-sm">{trans("No, I don’t")}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className='w-full flex flex-wrap px-4 py-2'>
                    ...
                    <div className='w-full flex flex-wrap gap-2'>
                        <div className="flex items-center justify-center border rounded-xl max-w-fit p-2 py-3 gap-2">
                            <span className="text-gray-700 text-sm">{trans("Associate Degree")}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className='w-full flex flex-wrap px-4 py-2'>
                    ...
                    <div className='w-full flex flex-wrap gap-2'>
                        <div className="flex items-center justify-center border rounded-xl max-w-fit p-2 py-3 gap-2">
                            <span className="text-gray-700 text-sm">{trans("Once a month")}</span>
                        </div>
                    </div>
                </div>

                <div className='w-full flex flex-wrap px-4 py-2'>
                    <h4 className='w-full font-bold py-2'>{trans("Diet")}</h4>
                    <div className='w-full flex flex-wrap gap-2'>
                        <div className="flex items-center justify-center border rounded-xl max-w-fit p-2 py-3 gap-2">
                            <span className="text-gray-700 text-sm">{trans("I’m vegan")}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className='w-full flex flex-wrap px-4 py-2'>
                    ...
                    <div className='w-full flex flex-wrap gap-2'>
                        <div className="flex items-center justify-center border rounded-xl max-w-fit p-2 py-3 gap-2">
                            <span className="text-gray-700 text-sm">{trans("I am not religious")}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className='w-full flex flex-wrap px-4 py-2'>
                    ...
                    <div className="w-full p-2 rounded-xl flex flex-wrap  bg-white shadow-sm">
                        <Link href={"/app/%5Blocale%5D/profile/my-trips/create"} passHref prefetch={true}
                ...
                <div className='w-full flex flex-wrap px-4 py-2'>
                    ...
                    <div className='w-full flex flex-wrap gap-2'>
                        <div className="flex items-center justify-center border rounded-xl max-w-fit p-2 py-3 gap-2">
                            <Image src={InstagramDisableIcon} alt={"InstagramDisableIcon"} width={18} height={18}/>
                            <span className="text-gray-500 text-sm">{trans("Instagram")}</span>
                        </div>
                        <div className="flex items-center justify-center border rounded-xl max-w-fit p-2 py-3 gap-2">
                            <Image src={TikTokDisableIcon} alt={"TikTokDisableIcon"} width={18} height={18}/>
